...
use BAGArt\TelegramBot\ApiCommunication\Async\DtoPipelineDispatcher;
...
// Test 2.3: TgUpdateProcessor with registry (used in poller-sync.php)
...
$dispatcher = Mockery::mock(DtoPipelineDispatcher::class);
$dispatcher->shouldReceive('dispatch')->andReturnNull();
$config = new TgUpdateConfig(dispatcher: $dispatcher);
$processor = new UpdateDTOInitProcessor($registry, new TgBotLogWrapper(new Logger('tst')), $config);
