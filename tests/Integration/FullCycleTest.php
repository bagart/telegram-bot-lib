...
assert_test('1.1 update_id', $w1->makeDTO(messagePayload())->updateId === 987654321);
...
$upd4 = TgBotSetupFactory::webhook($r4)->makeDTO(callbackQueryPayload());
assert_test('1.4 callback update', $upd4 !== null && $upd4->callbackQuery !== null);
...
$upd7 = TgBotSetupFactory::webhook($r7)->makeDTO(inlineQueryPayload());
assert_test('1.7 inline update', $upd7 !== null && $upd7->inlineQuery !== null);
...
$botConfig33 = new TgBotConfig(token: TOKEN, botId: '123456789');
foreach ($proc->selectProcessors($upd33, $botConfig33) as $processors) {
    foreach ($processors as $processor) {
        $processor->process($upd33->message, $botConfig33);
    }
}
...
$upd43 = TgBotSetupFactory::webhook($r43)->makeDTO(['update_id' => 999999999]);
...
$upd48 = TgBotSetupFactory::webhook($r48)->makeDTO($e48);
assert_test('4.8 large update_id', $upd48 !== null && $upd48->updateId === 2147483647);
