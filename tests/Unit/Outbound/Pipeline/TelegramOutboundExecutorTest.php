...
/**
 * Self-contained $next spy: handler + mutable $called flag.
 * Returns [handler, box]; box->called is checked in the test.
 *
 * @return array{0: OutboundNextHandlerContract, 1: object}
 */
