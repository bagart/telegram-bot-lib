...
class SetWebhookMethodDTO implements TgApiMethodDTOContract
{
    ...
    public function __construct(
        #[Description('HTTPS URL to send updates to. Use an empty string to remove tg_webhook integration')]
        public string $url,
        ...
        #[Description('The fixed IP address which will be used to send tg_webhook requests instead of the IP address resolved through DNS')]
        public ?string $ipAddress = null,
        #[Description('The maximum allowed number of simultaneous HTTPS connections to the tg_webhook for update delivery, 1-100. Defaults to _40_. Use lower values to limit the load on your bot"s server, and higher values to increase your bot"s throughput.')]
        ...
        #[Description('A secret token to be sent in a header “X-Telegram-Bot-Api-Secret-Token” in every tg_webhook request, 1-256 characters. Only characters `A-Z`, `a-z`, `0-9`, `_` and `-` are allowed. The header is useful to ensure that the request comes from a tg_webhook set by you.')]
