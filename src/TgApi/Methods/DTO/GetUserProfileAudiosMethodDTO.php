...
use BAGArt\TelegramBot\TgApi\Types\DTO\UserProfileAudiosTypeDTO;
...
class GetUserProfileAudiosMethodDTO implements TgApiMethodDTOContract
{
    ...
    {
        return [
            UserProfileAudiosTypeDTO::class,
        ];
    }

    public static function tgApiEntity(): TgApiMethodsEnum
    {
        return TgApiMethodsEnum::getUserProfileAudios;
    }
