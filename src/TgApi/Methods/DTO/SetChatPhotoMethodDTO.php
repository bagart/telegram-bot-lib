...
class SetChatPhotoMethodDTO implements TgApiMethodDTOContract
{
    ...
    {
        return TgApiMethodsEnum::setChatPhoto;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"chat_id":{"property":"chatId","tgPropName":"chat_id","types":["string"],"tgTypes":[{"type":"int32"},{"type":"str"}],"nullable":false,"required":true},"photo":{"property":"photo","tgPropName":"photo","types":["string"],"tgTypes":[{"type":"input-file"}],"nullable":false,"required":true}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
