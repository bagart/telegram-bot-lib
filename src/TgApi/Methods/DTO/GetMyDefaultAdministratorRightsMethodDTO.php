...
class GetMyDefaultAdministratorRightsMethodDTO implements TgApiMethodDTOContract
{
    ...
    {
        return [
            ChatAdministratorRightsTypeDTO::class,
        ];
    }

    public static function tgApiEntity(): TgApiMethodsEnum
    {
        return TgApiMethodsEnum::getMyDefaultAdministratorRights;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"for_channels":{"property":"forChannels","tgPropName":"for_channels","types":["bool"],"tgTypes":[{"type":"bool"}],"nullable":true,"required":false}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
