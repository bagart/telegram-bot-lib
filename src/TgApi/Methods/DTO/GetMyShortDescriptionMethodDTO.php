...
use BAGArt\TelegramBot\TgApi\Types\DTO\BotShortDescriptionTypeDTO;
...
class GetMyShortDescriptionMethodDTO implements TgApiMethodDTOContract
{
    ...
    {
        return [
            BotShortDescriptionTypeDTO::class,
        ];
    }

    public static function tgApiEntity(): TgApiMethodsEnum
    {
        return TgApiMethodsEnum::getMyShortDescription;
    }
