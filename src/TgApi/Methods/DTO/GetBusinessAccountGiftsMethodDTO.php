...
class GetBusinessAccountGiftsMethodDTO implements TgApiMethodDTOContract
{
    ...
    public function __construct(
        ...
        #[Description('Pass _True_ to exclude gifts that aren"t saved to the account"s profile page')]
        public ?bool $excludeUnsaved = null,
        #[Description('Pass _True_ to exclude gifts that are saved to the account"s profile page')]
    ...
    {
        return TgApiMethodsEnum::getBusinessAccountGifts;
    }
