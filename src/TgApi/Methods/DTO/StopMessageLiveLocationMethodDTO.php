...
class StopMessageLiveLocationMethodDTO implements TgApiMethodDTOContract
{
    ...
    public function __construct(
        ...
        #[Description('Required if _inline\_message\_id_ is not specified. Identifier of the message with live location to stop')]
    ...
    {
        return TgApiMethodsEnum::stopMessageLiveLocation;
    }
