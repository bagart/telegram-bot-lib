...
use BAGArt\TelegramBot\TgApi\Methods\Enum\EmojiEnum;
...
class SendDiceMethodDTO implements TgApiMethodDTOContract
{
    ...
    {
        return TgApiMethodsEnum::sendDice;
    }
