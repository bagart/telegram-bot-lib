...
class GetChatGiftsMethodDTO implements TgApiMethodDTOContract
{
    ...
    public function __construct(
        ...
        #[Description('Pass _True_ to exclude gifts that aren"t saved to the chat"s profile page. Always _True_, unless the bot has the _can\_post\_messages_ administrator right in the channel.')]
        public ?bool $excludeUnsaved = null,
        #[Description('Pass _True_ to exclude gifts that are saved to the chat"s profile page. Always _False_, unless the bot has the _can\_post\_messages_ administrator right in the channel.')]
    ...
    {
        return TgApiMethodsEnum::getChatGifts;
    }
