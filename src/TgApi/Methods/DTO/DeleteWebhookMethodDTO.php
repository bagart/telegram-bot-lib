...
class DeleteWebhookMethodDTO implements TgApiMethodDTOContract
{
    ...
    {
        return TgApiMethodsEnum::deleteWebhook;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"drop_pending_updates":{"property":"dropPendingUpdates","tgPropName":"drop_pending_updates","types":["bool"],"tgTypes":[{"type":"bool"}],"nullable":true,"required":false}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
