...
class SetMyShortDescriptionMethodDTO implements TgApiMethodDTOContract
{
    ...
    {
        return TgApiMethodsEnum::setMyShortDescription;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"short_description":{"property":"shortDescription","tgPropName":"short_description","types":["string"],"tgTypes":[{"type":"str"}],"nullable":true,"required":false},"language_code":{"property":"languageCode","tgPropName":"language_code","types":["string"],"tgTypes":[{"type":"str"}],"nullable":true,"required":false}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
