...
class AddStickerToSetMethodDTO implements TgApiMethodDTOContract
{
    ...
    public function __construct(
        ...
        public string $name,
        #[Description('An object with information about the added sticker. If exactly the same sticker had already been added to the set, then the set isn"t changed.')]
    ...
    {
        return TgApiMethodsEnum::addStickerToSet;
    }
