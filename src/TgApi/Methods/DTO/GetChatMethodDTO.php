...
use BAGArt\TelegramBot\TgApi\Types\DTO\ChatFullInfoTypeDTO;
...
class GetChatMethodDTO implements TgApiMethodDTOContract
{
    ...
    {
        return [
            ChatFullInfoTypeDTO::class,
        ];
    }

    public static function tgApiEntity(): TgApiMethodsEnum
    {
        return TgApiMethodsEnum::getChat;
    }
