...
class VerifyUserMethodDTO implements TgApiMethodDTOContract
{
    ...
    {
        return TgApiMethodsEnum::verifyUser;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"user_id":{"property":"userId","tgPropName":"user_id","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":false,"required":true},"custom_description":{"property":"customDescription","tgPropName":"custom_description","types":["string"],"tgTypes":[{"type":"str"}],"nullable":true,"required":false}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
