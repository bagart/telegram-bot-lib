...
class RevokeChatInviteLinkMethodDTO implements TgApiMethodDTOContract
{
    ...
    {
        return TgApiMethodsEnum::revokeChatInviteLink;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"chat_id":{"property":"chatId","tgPropName":"chat_id","types":["string"],"tgTypes":[{"type":"int32"},{"type":"str"}],"nullable":false,"required":true},"invite_link":{"property":"inviteLink","tgPropName":"invite_link","types":["string"],"tgTypes":[{"type":"str"}],"nullable":false,"required":true}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
