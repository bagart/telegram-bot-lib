...
enum TgApiMethodsEnum: string implements TgApiEntityEnumContract
{
    ...
    #[Description('Use this method to close the bot instance before moving it from one local server to another. You need to delete the tg_webhook before calling this method to ensure that the bot isn"t launched again after server restart. The method will return error 429 in the first 10 minutes after the bot is launched. Returns _True_ on success. Requires no parameters.')]
    ...
    #[Description('Use this method to change the title of a chat. Titles can"t be changed for private tg_chats. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Returns _True_ on success.')]
    ...
    #[Description('Use this method to clear the list of pinned messages in a chat. In private tg_chats and channel direct messages tg_chats, no additional rights are required to unpin all pinned messages. Conversely, the bot must be an administrator with the "can\_pin\_messages" right or the "can\_edit\_messages" right to unpin all pinned messages in groups and channels respectively. Returns _True_ on success.')]
    ...
    #[Description('Use this method to delete a message, including service messages, with the following limitations:; ; \- A message can only be deleted if it was sent less than 48 hours ago.; ; \- Service messages about a supergroup, channel, or forum topic creation can"t be deleted.; ; \- A dice message in a private chat can only be deleted if it was sent more than 24 hours ago.; ; \- Bots can delete outgoing messages in private tg_chats, groups, and supergroups.; ; \- Bots can delete incoming messages in private tg_chats.; ; \- Bots granted _can\_post\_messages_ permissions can delete outgoing messages in channels.; ; \- If the bot is an administrator of a group, it can delete any message there.; ; \- If the bot has _can\_delete\_messages_ administrator right in a supergroup or a channel, it can delete any message there.; ; \- If the bot has _can\_manage\_direct\_messages_ administrator right in a channel, it can delete any message in the corresponding direct messages chat.; ; Returns _True_ on success.')]
