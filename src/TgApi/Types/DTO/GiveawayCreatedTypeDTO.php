...
class GiveawayCreatedTypeDTO implements TgApiTypeDTOContract
{
    ...
    {
        return TgApiTypesEnum::GiveawayCreated;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"prize_star_count":{"property":"prizeStarCount","tgPropName":"prize_star_count","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":true,"required":false}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
