...
class LabeledPriceTypeDTO implements TgApiTypeDTOContract
{
    ...
    {
        return TgApiTypesEnum::LabeledPrice;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"label":{"property":"label","tgPropName":"label","types":["string"],"tgTypes":[{"type":"str"}],"nullable":false,"required":true},"amount":{"property":"amount","tgPropName":"amount","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":false,"required":true}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
