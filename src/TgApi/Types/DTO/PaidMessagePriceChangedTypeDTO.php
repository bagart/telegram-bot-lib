...
class PaidMessagePriceChangedTypeDTO implements TgApiTypeDTOContract
{
    ...
    {
        return TgApiTypesEnum::PaidMessagePriceChanged;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"paid_message_star_count":{"property":"paidMessageStarCount","tgPropName":"paid_message_star_count","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":false,"required":true}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
