...
class ForceReplyTypeDTO implements TgApiTypeDTOContract
{
    ...
    public function __construct(
        ...
        #[Description('Use this parameter if you want to force reply from specific users only. Targets: 1) users that are @mentioned in the _text_ of the [Message](https://core.telegram.org/bots/api#message) object; 2) if the bot"s message is a reply to a message in the same chat and forum topic, sender of the original message.')]
    ...
    {
        return TgApiTypesEnum::ForceReply;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"force_reply":{"property":"forceReply","tgPropName":"force_reply","types":["bool"],"tgTypes":[{"type":"bool","literal":true}],"nullable":false,"required":true},"input_field_placeholder":{"property":"inputFieldPlaceholder","tgPropName":"input_field_placeholder","types":["string"],"tgTypes":[{"type":"str"}],"nullable":true,"required":false},"selective":{"property":"selective","tgPropName":"selective","types":["bool"],"tgTypes":[{"type":"bool"}],"nullable":true,"required":false}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
