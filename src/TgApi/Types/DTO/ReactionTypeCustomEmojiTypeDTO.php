...
class ReactionTypeCustomEmojiTypeDTO implements TgApiTypeDTOContract, \BAGArt\TelegramBot\Contracts\TgApi\TgApiOneOfVariantContract
{
    ...
    public function __construct(
        ...
        #[Description('Type of the reaction, always “custom\_emoji”')]
    ...
    {
        return TgApiTypesEnum::ReactionTypeCustomEmoji;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"type":{"property":"type","tgPropName":"type","types":["string"],"tgTypes":[{"type":"str","literal":"custom_emoji"}],"nullable":false,"required":true},"custom_emoji_id":{"property":"customEmojiId","tgPropName":"custom_emoji_id","types":["string"],"tgTypes":[{"type":"str"}],"nullable":false,"required":true}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
