...
class VideoTypeDTO implements TgApiTypeDTOContract
{
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"file_id":{"property":"fileId","tgPropName":"file_id","types":["string"],"tgTypes":[{"type":"str"}],"nullable":false,"required":true},"file_unique_id":{"property":"fileUniqueId","tgPropName":"file_unique_id","types":["string"],"tgTypes":[{"type":"str"}],"nullable":false,"required":true},"width":{"property":"width","tgPropName":"width","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":false,"required":true},"height":{"property":"height","tgPropName":"height","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":false,"required":true},"duration":{"property":"duration","tgPropName":"duration","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":false,"required":true},"thumbnail":{"property":"thumbnail","tgPropName":"thumbnail","types":["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\PhotoSizeTypeDTO"],"tgTypes":[{"type":"api-type","name":"PhotoSize"}],"nullable":true,"required":false},"cover":{"property":"cover","tgPropName":"cover","types":[["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\PhotoSizeTypeDTO"]],"tgTypes":[{"type":"array","of":{"type":"api-type","name":"PhotoSize"}}],"nullable":true,"required":false},"start_timestamp":{"property":"startTimestamp","tgPropName":"start_timestamp","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":true,"required":false},"qualities":{"property":"qualities","tgPropName":"qualities","types":[["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\VideoQualityTypeDTO"]],"tgTypes":[{"type":"array","of":{"type":"api-type","name":"VideoQuality"}}],"nullable":true,"required":false},"file_name":{"property":"fileName","tgPropName":"file_name","types":["string"],"tgTypes":[{"type":"str"}],"nullable":true,"required":false},"mime_type":{"property":"mimeType","tgPropName":"mime_type","types":["string"],"tgTypes":[{"type":"str"}],"nullable":true,"required":false},"file_size":{"property":"fileSize","tgPropName":"file_size","types":["string"],"tgTypes":[{"type":"int53"}],"nullable":true,"required":false}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
