...
class PassportElementErrorFrontSideTypeDTO implements TgApiTypeDTOContract
{
    ...
    public function __construct(
        ...
        public \BAGArt\TelegramBot\TgApi\Types\Enum\PassportElementErrorFrontSidePropTypeEnum $type,
        #[Description('Base64-encoded hash of the file with the front side of the document')]
        public string $fileHash,
        #[Description('Error message')]
        public string $message,
        #[Description('Error source, must be _front\_side_')]
    ...
    {
        return TgApiTypesEnum::PassportElementErrorFrontSide;
    }
