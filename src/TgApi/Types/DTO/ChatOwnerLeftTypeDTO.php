...
class ChatOwnerLeftTypeDTO implements TgApiTypeDTOContract
{
    ...
    {
        return TgApiTypesEnum::ChatOwnerLeft;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"new_owner":{"property":"newOwner","tgPropName":"new_owner","types":["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\UserTypeDTO"],"tgTypes":[{"type":"api-type","name":"User"}],"nullable":true,"required":false}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
