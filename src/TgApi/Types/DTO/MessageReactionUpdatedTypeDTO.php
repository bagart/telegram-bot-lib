...
class MessageReactionUpdatedTypeDTO implements TgApiTypeDTOContract
{
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"chat":{"property":"chat","tgPropName":"chat","types":["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatTypeDTO"],"tgTypes":[{"type":"api-type","name":"Chat"}],"nullable":false,"required":true},"message_id":{"property":"messageId","tgPropName":"message_id","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":false,"required":true},"user":{"property":"user","tgPropName":"user","types":["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\UserTypeDTO"],"tgTypes":[{"type":"api-type","name":"User"}],"nullable":true,"required":false},"actor_chat":{"property":"actorChat","tgPropName":"actor_chat","types":["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatTypeDTO"],"tgTypes":[{"type":"api-type","name":"Chat"}],"nullable":true,"required":false},"date":{"property":"date","tgPropName":"date","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":false,"required":true},"old_reaction":{"property":"oldReaction","tgPropName":"old_reaction","types":[["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ReactionTypeEmojiTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ReactionTypeCustomEmojiTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ReactionTypePaidTypeDTO"]],"tgTypes":[{"type":"array","of":{"type":"api-type","name":"ReactionType"}}],"nullable":false,"required":true},"new_reaction":{"property":"newReaction","tgPropName":"new_reaction","types":[["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ReactionTypeEmojiTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ReactionTypeCustomEmojiTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ReactionTypePaidTypeDTO"]],"tgTypes":[{"type":"array","of":{"type":"api-type","name":"ReactionType"}}],"nullable":false,"required":true}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
