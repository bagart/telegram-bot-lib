...
class BotCommandScopeChatMemberTypeDTO implements TgApiTypeDTOContract
{
    ...
    public function __construct(
        ...
        public int $userId,
        #[Description('Scope type, must be _chat\_member_')]
    ...
    {
        return TgApiTypesEnum::BotCommandScopeChatMember;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"type":{"property":"type","tgPropName":"type","types":["string"],"tgTypes":[{"type":"str","literal":"chat_member"}],"nullable":false,"required":true},"chat_id":{"property":"chatId","tgPropName":"chat_id","types":["string"],"tgTypes":[{"type":"int32"},{"type":"str"}],"nullable":false,"required":true},"user_id":{"property":"userId","tgPropName":"user_id","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":false,"required":true}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
