...
class ChatMemberUpdatedTypeDTO implements TgApiTypeDTOContract
{
    ...
    public function __construct(
        ...
        public \BAGArt\TelegramBot\TgApi\Types\DTO\ChatMemberAdministratorTypeDTO|\BAGArt\TelegramBot\TgApi\Types\DTO\ChatMemberBannedTypeDTO|\BAGArt\TelegramBot\TgApi\Types\DTO\ChatMemberLeftTypeDTO|\BAGArt\TelegramBot\TgApi\Types\DTO\ChatMemberMemberTypeDTO|\BAGArt\TelegramBot\TgApi\Types\DTO\ChatMemberOwnerTypeDTO|\BAGArt\TelegramBot\TgApi\Types\DTO\ChatMemberRestrictedTypeDTO $oldChatMember,
        #[Description('New information about the chat member')]
        public \BAGArt\TelegramBot\TgApi\Types\DTO\ChatMemberAdministratorTypeDTO|\BAGArt\TelegramBot\TgApi\Types\DTO\ChatMemberBannedTypeDTO|\BAGArt\TelegramBot\TgApi\Types\DTO\ChatMemberLeftTypeDTO|\BAGArt\TelegramBot\TgApi\Types\DTO\ChatMemberMemberTypeDTO|\BAGArt\TelegramBot\TgApi\Types\DTO\ChatMemberOwnerTypeDTO|\BAGArt\TelegramBot\TgApi\Types\DTO\ChatMemberRestrictedTypeDTO $newChatMember,
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"chat":{"property":"chat","tgPropName":"chat","types":["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatTypeDTO"],"tgTypes":[{"type":"api-type","name":"Chat"}],"nullable":false,"required":true},"from":{"property":"from","tgPropName":"from","types":["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\UserTypeDTO"],"tgTypes":[{"type":"api-type","name":"User"}],"nullable":false,"required":true},"date":{"property":"date","tgPropName":"date","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":false,"required":true},"old_chat_member":{"property":"oldChatMember","tgPropName":"old_chat_member","types":["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatMemberAdministratorTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatMemberBannedTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatMemberLeftTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatMemberMemberTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatMemberOwnerTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatMemberRestrictedTypeDTO"],"tgTypes":[{"type":"api-type","name":"ChatMember"}],"nullable":false,"required":true},"new_chat_member":{"property":"newChatMember","tgPropName":"new_chat_member","types":["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatMemberAdministratorTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatMemberBannedTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatMemberLeftTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatMemberMemberTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatMemberOwnerTypeDTO","\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatMemberRestrictedTypeDTO"],"tgTypes":[{"type":"api-type","name":"ChatMember"}],"nullable":false,"required":true},"invite_link":{"property":"inviteLink","tgPropName":"invite_link","types":["\\BAGArt\\TelegramBot\\TgApi\\Types\\DTO\\ChatInviteLinkTypeDTO"],"tgTypes":[{"type":"api-type","name":"ChatInviteLink"}],"nullable":true,"required":false},"via_join_request":{"property":"viaJoinRequest","tgPropName":"via_join_request","types":["bool"],"tgTypes":[{"type":"bool"}],"nullable":true,"required":false},"via_chat_folder_invite_link":{"property":"viaChatFolderInviteLink","tgPropName":"via_chat_folder_invite_link","types":["bool"],"tgTypes":[{"type":"bool"}],"nullable":true,"required":false}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
