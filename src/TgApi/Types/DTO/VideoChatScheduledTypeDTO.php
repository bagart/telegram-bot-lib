...
class VideoChatScheduledTypeDTO implements TgApiTypeDTOContract
{
    ...
    {
        return TgApiTypesEnum::VideoChatScheduled;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"start_date":{"property":"startDate","tgPropName":"start_date","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":false,"required":true}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
