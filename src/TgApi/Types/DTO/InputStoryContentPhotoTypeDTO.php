...
class InputStoryContentPhotoTypeDTO implements TgApiTypeDTOContract, \BAGArt\TelegramBot\Contracts\TgApi\TgApiOneOfVariantContract
{
    ...
    public function __construct(
        ...
        public string $photo,
        #[Description('Type of the content, must be _photo_')]
    ...
    {
        return TgApiTypesEnum::InputStoryContentPhoto;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"type":{"property":"type","tgPropName":"type","types":["string"],"tgTypes":[{"type":"str","literal":"photo"}],"nullable":false,"required":true},"photo":{"property":"photo","tgPropName":"photo","types":["string"],"tgTypes":[{"type":"str"}],"nullable":false,"required":true}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
