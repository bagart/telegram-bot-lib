...
class BotCommandScopeAllChatAdministratorsTypeDTO implements TgApiTypeDTOContract, \BAGArt\TelegramBot\Contracts\TgApi\TgApiOneOfVariantContract
{
    ...
    public function __construct(
        #[Description('Scope type, must be _all\_chat\_administrators_')]
    ...
    {
        return TgApiTypesEnum::BotCommandScopeAllChatAdministrators;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"type":{"property":"type","tgPropName":"type","types":["string"],"tgTypes":[{"type":"str","literal":"all_chat_administrators"}],"nullable":false,"required":true}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
