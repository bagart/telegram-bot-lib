...
class InlineQueryResultCachedStickerTypeDTO implements TgApiTypeDTOContract
{
    ...
    {
        return TgApiTypesEnum::InlineQueryResultCachedSticker;
    }
