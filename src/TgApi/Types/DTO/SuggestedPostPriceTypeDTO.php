...
class SuggestedPostPriceTypeDTO implements TgApiTypeDTOContract
{
    ...
    {
        return TgApiTypesEnum::SuggestedPostPrice;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"currency":{"property":"currency","tgPropName":"currency","types":["\\BAGArt\\TelegramBot\\TgApi\\Types\\Enum\\CurrencyEnum"],"tgTypes":[{"type":"str","literal":"XTR"},{"type":"str","literal":"TON"}],"nullable":false,"required":true},"amount":{"property":"amount","tgPropName":"amount","types":["int"],"tgTypes":[{"type":"int32"}],"nullable":false,"required":true}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
