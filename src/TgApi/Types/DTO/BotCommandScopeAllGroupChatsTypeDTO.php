...
class BotCommandScopeAllGroupChatsTypeDTO implements TgApiTypeDTOContract
{
    ...
    public function __construct(
        #[Description('Scope type, must be _all\_group\_chats_')]
    ...
    {
        return TgApiTypesEnum::BotCommandScopeAllGroupChats;
    }
    ...
    public static function tgPropertyMetas(): array
    {
        $metaByProp = json_decode(
            <<<'XJSON'
{"type":{"property":"type","tgPropName":"type","types":["string"],"tgTypes":[{"type":"str","literal":"all_group_chats"}],"nullable":false,"required":true}}
XJSON,
            true,
            20,
            JSON_THROW_ON_ERROR
