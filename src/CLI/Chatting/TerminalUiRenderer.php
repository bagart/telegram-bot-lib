...
final class TerminalUiRenderer implements TerminalUiRendererInterface
{
    ...
    /**
     * Fixed UI width.
     * It does not depend on terminal resize.
     */
    private int $boxWidth;

    /**
     * Fixed left UI position.
     * It is not recalculated after the first render.
     */
    ...
    private function initializeFixedLayout(): void
    {
        ...
        /**
         * Key fix:
         * leftOffset is calculated ONCE.
         * It does not change after terminal resize.
         *
         * UI does not "jump".
         */
    ...
    {
        /**
         * Keep 1 as the safest option
         * or try to center once.
         *
         * Intentionally fixed here.
         */
        return 1;
    }
    ...
    private function printAt(
         ...
         * so no artifacts remain after resize.
         */
        echo "\033[2K";
        echo $content;
    }
