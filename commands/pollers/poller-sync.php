...
php commands/pollers/poller-sync.php                # sync long-poll with DTO processor
php commands/pollers/poller-sync.php --help         # show help
php commands/pollers/poller-sync.php                # sync polling with DTOProcessor
