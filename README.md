...
php commands/poller-raw.php --help          # show help
php commands/poller-raw.php                 # receive updates in raw mode
  --echo                                    # echo reply to messages
  --show                                    # dump update objects
  --token=xxx:xxx                           # use custom token
```
...
|----------------------------|-----------------------------------|
| `TgUpdateProcessor`        | Build-in Technical                |
...
$processor->process($update, $tgBotId);
```
